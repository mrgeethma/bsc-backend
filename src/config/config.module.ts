...
@Module({
  imports: [
    NestConfigModule.forRoot({ // Configures the global configuration module with environment variables and validation
      ...
      validationSchema: Joi.object({ // Defining a Joi schema to validate environment variables and configuration settings
        // Database
