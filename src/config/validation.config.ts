...
export const validationSchema = Joi.object({ //joi.object creates a new schema object
  ...
  DATABASE_SYNCHRONIZE: Joi.alternatives().try( //synchronize can be boolean or string 'true'/'false'. if DATABASE_SYNCHRONIZE not defined, it defaults to true in development environment
    Joi.boolean(),
